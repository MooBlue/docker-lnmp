...
> Docker-LNMP 可以构建出基于 Docker 的 PHP 开发环境，其优势有在短时间内随意构建不同版本的相关服务、环境统一分布在不同服务器等，使开发者能够更专注于开发业务本身。另外产品针对国内用户提供了良好的本地化定制（系统时区为中国、apt-get 源为 163、php composer 为 laravel-china 的）
